...
short noindiv[165][7];
list<Cball>::iterator gridindiv[162][7][501];
...
short  AA, AB, BB,tot,y2,t1,b1,xg,yg,ff,r,t,b,i,j,n,xx,yy,jj[4];
	...
	for(j=1;j<=3;j++)
		{
			...
			if (iy >= yy)y2=yrange +yy;else y2=yy - yrange;
				...
				if(dist > dist2) dist=dist2;
					...
					if (sexi==0 && dist <= 150 && gridindiv[i][jj[j]][n]->sexi==1)// count number of mailes within the ara of radius 200
					{
